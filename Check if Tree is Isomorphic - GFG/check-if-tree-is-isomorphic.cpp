...
/*Complete the function below Node is as follows: 
struct Node {
    int data;
    Node *left;
    Node *right;
...
public:
    ...
    bool isIsomorphic(Node *root1, Node *root2) {
        ...
        // If one of the trees is empty but not both, they are not isomorphic.
        if (!root1 || !root2) {
            return false;
        }
        // If the data at the current nodes is not the same, they are not isomorphic.
        if (root1->data != root2->data) {
            return false;
        }
        
        // Check isomorphism for both possible cases:
        // 1. Without swapping subtrees.
        // 2. By swapping left and right subtrees.
